...
*/
char* pblCgiTest001HelloWorld_c_id = "$Id: pblCgiTest001HelloWorld.c,v 1.2 2018/03/10 16:22:21 peter Exp $";
...
{
	FILE * stream;
	char * traceFilePath = "D:/Temp/PBL_CGI_TRACE.LOG";
#ifdef WIN32
	...
	pblCgiPrint("C:/Users/peter/workspace/pbl/templates/", "Test003_HelloWorld.html", "text/html");
